...
<!-- 导航条-->
         <div style="margin-top: 10px;margin-left:50px;width:1190px;height:30px;float: left;
     line-height: 30px">
     <div style="float: left;width: 250px;margin-left:60px"><a href="index">返回首页</a></div>
