...
<div class="alert alert-danger" role="alert" >
  <h4 class="alert-heading" class="text-success">保存成功！</h4>
  <p>
  </p>
...
<script type="text/javascript">
	...
	function countDown(){
		//将count显示在div中
		document.getElementById("div1").innerHTML= count+"秒后跳转到浏览界面";
		//没执行一次，count减1
		count -= 1;
		//count=0时，跳转页面
		if(count==0){
			location.href="${pageContext.request.contextPath}/normalloginindex";
